...
export const Pingo = {
  ...
  template: `
    <div class="app">
      <div
        :class="currentNumberClass"
        role="status"
        aria-live="polite"
        aria-atomic="true"
      >{{ formatNumber(currentNumber) }}</div>
      <div class="history-container" aria-label="Números já sorteados">
      ...
      <div class="button-container">
        <button
          ...
          @click="start"
          class="spin start"
          aria-label="Começar sorteio"
        >Começar</button>
        <button
          v-else
          @click="stop(false)"
          class="spin stop"
          aria-label="Parar sorteio"
        >Parar</button>
        <button
          @click="resetWithConfirm"
          class="reset"
          aria-label="Reiniciar bingo"
        >Reiniciar</button>
      </div>
      <transition name="modal-fade">
        ...
        >
          ...
          >
            <p id="modal-reset-title">Você realmente deseja reiniciar?</p>
